...
project = 'Kria™ KR260: ROS 2 Multi-Node Communications Via TSN'
project_u = project.replace(' ', '_')
copyright = '2023-' + datetime.now().strftime("%Y") + ', ' + author
...
master_doc = 'ros2_multinode_communication_via_tsn_landing'
