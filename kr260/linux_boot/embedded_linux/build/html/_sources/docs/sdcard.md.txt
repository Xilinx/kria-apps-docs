...
1. Download one of the Kria Starter Kit Linux pre-built SD card image, from [embedded Linux releases](https://xilinx-wiki.atlassian.net/wiki/spaces/A/pages/1641152513/Kria+SOMs+Starter+Kits#Embedded-Linux-(Yocto)) and save it on your computer. Choose the appropriate image based on the applications (and their version) targeted. Refer back to [Linux boot landing page](https://pages.gitenterprise.xilinx.com/techdocs/SOM/kr260/linux_boot.html) for compatible applications for each Linux version.
