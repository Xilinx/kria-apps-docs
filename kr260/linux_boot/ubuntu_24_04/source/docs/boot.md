...
Try out one of the applications! Check the [Ubuntu 24.04 row](https://xilinx.github.io/kria-apps-docs/kr260/linux_boot.html) for supported application in Ubuntu 24.04.
