# Vitis Platform Flow Example - Adding RasPi Camera to SmartCam's Platform
...
```
 ...
 In the docker container, now we can use the gstreamer commands below to display RasPi sensor information onto as 1080p monitor:
