...
.. toctree::
   ...
   docs/creating_applications_vitis_accel_flow
   docs/creating_applications_vitis_platform_flow
   docs/creating_applications_vivado_accel_flow
   docs/creating_applications_vivado_accel_example
   docs/creating_applications_custom_cc_flow
   docs/creating_applications_baremetal
...
.. toctree::
   ...
   docs/creating_applications_target
   docs/creating_applications_bootmodes
   docs/creating_applications_dtsi_dtbo_generation
...
- :doc:`docs/creating_applications_vitis_accel_flow`
- :doc:`docs/creating_applications_vitis_platform_flow`
- :doc:`docs/creating_applications_vivado_accel_flow`
- :doc:`docs/creating_applications_custom_cc_flow`
...
If using the Kria Starter Kit with the Linux reference design, developers can also use `on-target utilities <./creating_applications_target>`_ to move their applications over and test. 

If using the Kria Starter Kit a user can use various boot-modes to test monolithic boot of application software using `these TCL scripts <./creating_applications_bootmodes>`_ to override the Starter Kit hardware defined QSPI32 boot mode.
