...
.. toctree::
   ...
   docs/Generate_vivado_project_from_CED
...
.. note::
   The default SOM Kria Starter Kit Flow leverages dynamic bitstream management in place of the legacy Zynq MPSoC evaluation board flow which used a monolithic boot file with integrated bitstream. See the differences in :doc:`docs/bitstream_management`.
