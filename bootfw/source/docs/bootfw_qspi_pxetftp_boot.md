...
This document assumes that you have had experience booting Linux on the Starter Kit via other boot methods (SD by default), are familiar with how to interact with the Starter Kit via the serial port, and have updated the bootfw on the Starter Kit. If not, go through [Booting Linux on the KV260](https://xilinx.github.io/kria-apps-docs/kv260/linux_boot.html) or [Booting Linux on the KR260](https://xilinx.github.io/kria-apps-docs/kr260/linux_boot.html) before following the steps in this document.
...
If booting PetaLinux, this also assumes that you are familiar with PetaLinux and have installed the appropriate version of PetaLinux on the Linux host computer. Refer to the PetaLinux Tools Documentation: Reference Guide ([UG1144](https://docs.amd.com/access/sources/dita/map?isLatest=true&url=ug1144-petalinux-tools-reference-guide&ft:locale=en-US)) for more information on PetaLinux and [download page](https://www.xilinx.com/support/download/index.html/content/xilinx/en/downloadNav/embedded-design-tools.html) for installation files. Ubuntu booting does not need PetaLinux tools.
