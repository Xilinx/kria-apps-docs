...
- Operating System: Xilinx Linux kernel + Yocto Project env
  - Drivers:
    - Uart-rs485
...
- Applications
  ...
  - tsn network-manager for pushing per-node Qbv/FDB schedules
  - lldpad / lldptool for frame-preemption (MAC Merge) enablement
...
Following are supported DDS implementation for ROS2 jazzy release:
