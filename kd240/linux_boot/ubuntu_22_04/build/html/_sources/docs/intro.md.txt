...
The remainder of this Getting Started Guide requires one of the [AMD Motor Accessory Packs](https://www.amd.com/en/products/system-on-modules/kria/k24/kd240-drives-starter-kit/kd240-motor-accessory-pack.html) for the Kria K24 SOM's applications.
If you don’t have a Motor Accessory Pack yet, there are still many very interesting things you can do with your kit—to get started with DSP applications on KD240, check out this detailed tutorial [in this link](https://www.hackster.io/whitney-knitter/dsp-for-soms-getting-started-with-dds-fir-compiler-ips-947cb4).
