...
```bash
pytest --board kv260 -m eeprom		# Run all tests in this module
pytest --board kv260 -k som_eeprom		# Run som_eeprom test
pytest --board kv260 -k carrier_card_eeprom	# Run carrier_card_eeprom test
```
