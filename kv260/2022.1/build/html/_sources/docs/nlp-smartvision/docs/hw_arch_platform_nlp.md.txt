...
A capture pipeline receives video frames from an external source and writes it into memory. This platform has 2 MIPI pipelines which captures video from AR1335 and IMX219 modules.
