...
Before continuing with the smartcam application specific instructions, if you have not yet done so, boot Linux with the instructions from the [Kria Starter Kit Linux boot](https://pages.gitenterprise.xilinx.com/techdocs/SOM/kv260/linux_boot.html) page.
...
Besides the hardware configurations required in the [Kria Starter Kit Linux boot](https://pages.gitenterprise.xilinx.com/techdocs/SOM/kv260/linux_boot.html) for booting Linux, the smartcam application requires the following hardware setup:
