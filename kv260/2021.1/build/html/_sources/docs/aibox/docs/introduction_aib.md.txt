...
The AI Box Distributed application design built on KV260 Vision AI Starter Kit provides one-stop solution for multiple camera capturing, streaming and cross camera pedestrian identification and monitoring.
...
* Go back to the [KV260 AI Box Distributed design start page](../aibox_landing)
