...
**Vitis AI 1.3.0** is the core underlying component to access the AI inference capability provided by Xilinx DPU.
...
![Gstreamer pipeline of the application](../../media/gstreamer-pipeline.png)
...
* Pedestrian Preprocess
    ...
    ivas_xmultisrc GStreamer plugin from IVAS with customized kernel /opt/xilinx/lib/libivas_pedpp.so are used to integrate the accelerator IP functionality into the pipeline.
