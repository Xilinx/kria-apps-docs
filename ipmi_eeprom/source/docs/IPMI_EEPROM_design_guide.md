...
This is the Xilinx definition for its EtherCat Addr MultiRecord. It is similar to [MAC Address MultiRecords](#mac-addr-multirecords) except the EtherCat ID is 4 bytes long.
